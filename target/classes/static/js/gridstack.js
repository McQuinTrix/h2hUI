...
(function (factory) {
    ...
    var GridStack = function (el, opts) {
        ...
        console.log(this.grid.get_grid_height());
        ...
        if (max_height > this._styles._max) {
            for (var i = this._styles._max; i < max_height; ++i) {
                Utils.insert_css_rule(this._styles,
                    ...
                    'height: ' + (((this.opts.cell_height * (i + 1) + this.opts.vertical_margin * i))/7.8) + '%;',
                    i
                );
                Utils.insert_css_rule(this._styles,
                ...
                Utils.insert_css_rule(this._styles,
                    prefix + '[data-gs-y="' + i + '"]',
                    'top: ' + ((this.opts.cell_height * i + this.opts.vertical_margin * i))/7.7 + '%;',
                    i
                );
            }
